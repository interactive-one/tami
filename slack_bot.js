...
controller.middleware.receive.use(function(bot, message, next) {
    ...
    if (message.text == 'hot' || message.text == 'trending' || message.text == 'top') {
        message.intent = 'trending';
    }
...
controller.hears(['trending'], 'direct_message', hear_intent, function(bot, message) {

    bot.startConversation(message,function(err,convo) {

        convo.ask("What site do you want me to check?", function(response, convo) {

            var username = 'Stranger';

            controller.storage.users.get(message.user, function(err, user, username) {
            ...
            //convo.say(message, 'Give me a second, ' + username + '. Processing...');
            //convo.next();
            ...
            // var url = 'http://api.chartbeat.com/live/toppages/v3/?apikey=38f1da95bee8d6d37b00f9d256437b4f&host=hellobeautiful.com';
            //
            //
            // req({url: url, json: true}, convo, function (error, response, body) {
